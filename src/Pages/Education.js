                    ...
                    <div className="row" key={i}>
                      ...
                      <div className="col-sm-7">
                        <div className="educationright">
                          ...
                          <h6 data-aos="fade-left"> {item.description}</h6>
                        </div>
                      </div>
                    </div>
                    <br />
                ...
                <div className="educationblock">
                  <div className="row">
                    <div className="col-sm-4">
                      <h5 data-aos="fade-right">Jan, 2021 - May, 2022</h5>
                    </div>
                    <div className="col-sm-8">
                      <div className="educationright" data-aos="fade-left">
                        <h5>"DEVELOPEMENT OF AN E-COMMERCE WEBSITE"</h5>
                        <h6> - Under the theme "FOOD DELIVERY"</h6>
                        <h6>
